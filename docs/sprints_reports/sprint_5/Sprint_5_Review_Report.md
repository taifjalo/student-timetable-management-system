...
|---|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|
| Taif Jalo | LocalizationService service, MessagesBundle_en/ar/ru.properties — Part of all string translations, Sprint Planning, Sprint reports, UserSettingsController and Login/Register console messages Localization display | 30               | Submitted      |
| Miska Voutilainen |                                                                                                                                                                                                                     | 0                | ?              |
