...
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|
| Taif Jalo | LocalizationService service, MessagesBundle_en/ar/ru.properties — Part of all string translations, Sprint Planning, Sprint reports, UserSettingsController update, | 30               | Submitted      |
| Miska Voutilainen |                                                                                                                                                                    | 0                | ?              |
