...
The following is a part of product backlog. Full product backlog is accessible through [this link](https://trello.com/b/dMPoj1HJ/sprint-4).

- Create notification system
- Finalize the product functionality
- Create presentation for the final presentation
- Create Docker Image
...
- Set up Sprint 4 board lists:
    - Sprint 4 Backlog, Done, Pending, In Progress, Postponed
- Document agreed decisions in Trello and GitHub

## Team Capacity & Assumptions

For Sprint 4, the team members agreed to:

- Work a few hours together on **Saturday** also working individually during the Sprint 4 period
- Meeting is conducted via **Discord**
...
A Sprint 4 task is considered done when:
